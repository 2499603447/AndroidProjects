...
public class NextOfKinDialog extends Dialog {
    ...
    @BindView(R.id.dialog_next_of_kin_name)
    public FloatingHintEditText mNameEdit;
    @BindView(R.id.dialog_next_of_kin_telephone)
    public FloatingHintEditText mTelephoneEdit;
